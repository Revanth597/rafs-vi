...
cooldown_ms = 1000
button_prev_state = 0
detection_enabled = False  # Start ON

# --- Camera/Lens parameters for distance estimation ---
FOCAL_LENGTH_MM = 4.37
SENSOR_WIDTH_MM = 6.4
KNOWN_WIDTH_M = 0.9# assumed average real object width
...
while not app.need_exit():
    ...
    # --- Button Toggle Logic ---
    button_state = button_pin.value()  # <-- FIXED HERE
    ...
    if objs:
        for obj in objs:
            ...
            # --- Distance Estimation ---
            distance_m = (KNOWN_WIDTH_M * FOCAL_LENGTH_MM * detector.input_width()) / (obj.w * SENSOR_WIDTH_MM)
